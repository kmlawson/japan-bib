#!/usr/bin/env python3
"""archive.org lookups for the Nachod (1928) books that are not already in the database.
...
import bje_merge as D  # noqa: E402
...
if __name__ == "__main__":
    ...
    def work(kr):
        ...
        with lock:
            with open(D.CACHE5, "a", encoding="utf-8") as f:
